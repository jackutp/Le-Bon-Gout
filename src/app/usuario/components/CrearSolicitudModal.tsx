...
import { TipoSolicitud, Subtarea, PrioridadJira } from "@/types/solicitud";
...
export default function CrearSolicitudModal({ isOpen, onClose, onSuccess, userName }: CrearSolicitudModalProps) {
    const { crearSolicitud, isLoading } = useSolicitudes();
    const [tipo, setTipo] = useState<TipoSolicitud>("SERVICIO");
